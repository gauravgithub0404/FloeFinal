          ...
          <div className="space-y-4">
            <div className="p-4 bg-indigo-950/40 rounded-xl border border-indigo-800/60 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-indigo-300 flex items-center gap-1.5">
                  ...
                  Render.com External Hosting Target
                </span>
                <span className="text-[10px] text-amber-400 bg-amber-950/80 px-2 py-0.5 rounded border border-amber-700/80 font-mono">
                  External Provider
                </span>
              </div>
              
              <div className="bg-slate-950 p-2.5 rounded-lg border border-slate-800 text-xs font-mono text-slate-400 break-all select-all">
                <span>{renderUrl}</span>
              </div>

              <div className="p-3 bg-slate-950/80 rounded-lg border border-amber-900/40 text-[11px] text-amber-200/90 space-y-1.5">
                <div className="font-semibold text-amber-300 flex items-center gap-1.5">
                  <Info className="w-3.5 h-3.5" />
                  Why does this external URL show "Not Found"?
                </div>
                <p className="text-slate-300 leading-relaxed">
                  <code className="text-amber-300 font-mono">*.onrender.com</code> subdomains are only activated when you deploy the generated repo directly to your own Render.com dashboard with a <code className="text-indigo-300 font-mono">RENDER_API_KEY</code>.
                </p>
                <p className="text-emerald-300 leading-relaxed font-medium">
                  To test your application right now with live PostgreSQL database and REST APIs, use the <strong>Public Cloud Testbed (Google Cloud Run)</strong> below.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              >
                ...
                <span>Switch to Active Public Cloud URL</span>
              </button>
              <a
                href={publicUrl}
                target="_blank"
